...
<Keybind keyBinding="Space" action={() => shoot()} disabled={gameStarted.not()} />;
```
...
```tsx
<MapView mapAsset={gameWorld.mapAsset} player={gameWorld.player} width={60} height={20} />
```
...
```tsx
<FirstPersonView mapAsset={gameWorld.mapAsset} player={gameWorld.player} scene="brick-wall" />
```
...
<Column width="100%" height="100%">
  <FirstPersonView
    ...
    height={30}
  />
  <MapView mapAsset={gameWorld.mapAsset} player={gameWorld.player} height={15} />
</Column>
```
